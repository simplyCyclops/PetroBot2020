...
public class Run2 extends RobotRun {
	...
	public void runInstructions() {
		...
		RobotMap.getChassis().forwardDriveDegrees(0.2, 0.6, Conversion.cmToDegrees(6), false);
		Wait.waitForSeconds(0.3);
		...
		RobotMap.getMotor("rArm").rotateDegrees(-0.1, 105, true);
		
		//back off slowly
		RobotMap.getChassis().backwardDriveDegrees(0.3, 0.1, Conversion.cmToDegrees(10), false);
		
		//drive back
		RobotMap.getChassis().backwardDriveDegrees(0.6, 0.1, Conversion.cmToDegrees(32), true);
		...
		GyroFollow.followDegrees(0.5, 0.1, 0.012, 0, Conversion.cmToDegrees(35), -1, false);
		...
		RobotMap.getChassis().forwardDriveDegrees(0.3, 0.6, Conversion.cmToDegrees(17), true);
